...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<actionpack>, [">= 5.0.1", "~> 5.x"])
      s.add_runtime_dependency(%q<actionview>, [">= 5.0.1", "~> 5.x"])
      s.add_runtime_dependency(%q<activesupport>, ["~> 5.x"])
      s.add_development_dependency(%q<railties>, ["~> 5.x"])
      s.add_development_dependency(%q<sqlite3>, [">= 0"])
    else
      s.add_dependency(%q<actionpack>, [">= 5.0.1", "~> 5.x"])
      s.add_dependency(%q<actionview>, [">= 5.0.1", "~> 5.x"])
